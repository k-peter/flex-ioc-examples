...
public class DumbAccordian extends Container implements IHistoryManagerClient, IFocusManagerComponent
{
     ...
     *  Constructor.
     */
    public function DumbAccordian()
    {
        super();

        headerRenderer = new ClassFactory(DumbAccordianHeader);
